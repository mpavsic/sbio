![strukturna biologija](logo/logo_sbio_l.png)
...
Glavno študijsko gradivo so drsnice s predavanj (naložene so v [spletno učilnico UL FKKT](https://ucilnica.fkkt.uni-lj.si) pod predmet **Strukturna biologija**), knjige, predpisane v predmetniku, in tekoča znanstvena literatura (izbrani raziskovalni in pregledni članki).
